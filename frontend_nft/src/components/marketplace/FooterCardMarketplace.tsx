...
import iconRedeem from '../../assets/nft-card/redeem.png'
import startImage from '../../assets/nft-card/star.png'
...
export const FooterCardMarketplace = ({ chainId }: FooterCardMarketplaceProps): JSX.Element => {
  ...
  return (
    <S.Content>
      ...
      <div>
        ...
        {(nftItem.status == 'SOLD' || nftItem.status == 'AUCTION_OR_SOLD') && (
          <S.Tag>
            <span>Ended</span>
            <S.TagRedeem>
