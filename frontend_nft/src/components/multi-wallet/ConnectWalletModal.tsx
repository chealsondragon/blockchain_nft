...
// import solanaIcon from '../../assets/multi-wallet/solana.png'
// import ftmIcon from '../../assets/multi-wallet/ftm.png'
import metamaskIcon from '../../assets/multi-wallet/metamask.svg'
// import phantomIcon from '../../assets/multi-wallet/phantom.png'
...
export const ConnectWalletModal = () => {
  ...
  return (
    <S.Modal title='Connect Wallet' onCancel={handleCancel} open={!!connectWalletModal} footer={null} destroyOnClose>
      <div>
        <S.BoxContainer>
          <S.ContainerCards>
